...
1. Downloaded latest MSVS-compiled x64 libtcod (libtcod-1.12.3-x86_64-msvc.zip) from https://github.com/libtcod/libtcod/releases
2. Extracted to D:\dev\libtcod-1.12.3-x86_64-msvc
3. Modified the top of the main "engine.py" file:

```Python
    libtcod_dir = "/dev/libtcod-1.12.3-x86_64-msvc/"
